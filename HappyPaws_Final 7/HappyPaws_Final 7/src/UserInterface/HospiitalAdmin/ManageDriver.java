...
public class ManageDriver extends javax.swing.JPanel {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        int selectedRow = tblManagerDriver.getSelectedRow();
        if (selectedRow >= 0) {
            int selectionButton = JOptionPane.YES_NO_OPTION;
            int selectionResult = JOptionPane.showConfirmDialog(null, "Confirm delete?", "Warning", selectionButton);
            if (selectionResult == JOptionPane.YES_OPTION) {
                String username = (String) tblManagerDriver.getValueAt(selectedRow, 1);
                String pwd = (String) tblManagerDriver.getValueAt(selectedRow, 2);
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        // TODO add your handling code here:
        int selectRow = tblManagerDriver.getSelectedRow();
        if (selectRow >= 0) {
            String name = (String) tblManagerDriver.getValueAt(selectRow, 0);
            String username = (String) tblManagerDriver.getValueAt(selectRow, 1);
            String password = (String) tblManagerDriver.getValueAt(selectRow, 2);
