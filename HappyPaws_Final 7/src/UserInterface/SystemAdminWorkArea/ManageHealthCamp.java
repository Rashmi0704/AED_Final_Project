...
public class ManageHealthCamp extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 80, 40));
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1050, 710));
    ...
    public void populateHealthCampTable() {
        ...
        for (UserAccount user : system.getUserAccountDirectory().getUserAccountList()) {
            ...
            if (user.getRole().getClass().getName().equals("HappyPawSystem.Role.HealthCampRole")) {
